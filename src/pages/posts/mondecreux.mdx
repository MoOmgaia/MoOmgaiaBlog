...
trajectory = {
  ...
  const traj = (a1, a2, center, step, r) => {
    ...
    d3.range(a1, a2, step).map(i => {
      ...
      points.push( new THREE.Vector2( ptXY.x + center.x, ptXY.y + center.y) );
    })
    return points;
  }
